...
<body>
    ...
    <div class="container">
        <div class="navbar-header">
         ...
         <div class="navbar-header">
            <a class="navbar-brand" href="/WebMarket/addProduct.jsp">상품추가(판매자메뉴)</a>
         </div>
         <div class="navbar-header">
            <a class="navbar-brand" href="/WebMarket/member/memberInfo.jsp">회원정보(관리자메뉴)</a>
         </div>
         <%
             //session을 가져오기
