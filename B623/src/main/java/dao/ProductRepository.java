...
public class ProductRepository {
  ...
  public ProductRepository() {
	  ...
	  Product tablet = new Product("P1236", "Galaxy Tab a", 900000);
	  tablet.setDescription("212.8*125.6*6.6mm, Super AMOLED display, Octo-Core processor");
